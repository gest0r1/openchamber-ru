...
const CHANGELOG_URL = 'https://raw.githubusercontent.com/gest0r1/openchamber-ru/main/CHANGELOG.md';
const GITHUB_BUG_REPORT_URL = 'https://github.com/gest0r1/openchamber-ru/issues/new?template=bug_report.yml';
const GITHUB_FEATURE_REQUEST_URL = 'https://github.com/gest0r1/openchamber-ru/issues/new?template=feature_request.yml';
