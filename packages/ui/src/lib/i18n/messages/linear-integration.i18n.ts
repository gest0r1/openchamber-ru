...
export const linearIntegrationI18n = {
  ...
  ru: {
    ...
    'settings.integrations.firstParty.info': 'Учётные записи сервисов и встроенных расширений OpenChamber. Учётные данные хранятся на выбранном сервере.',
    'settings.integrations.linear.title': 'Linear',
    'settings.integrations.linear.description': 'Подключите рабочие пространства Linear на этом сервере OpenChamber.',
    'settings.integrations.linear.info': 'Подключите одно или несколько рабочих пространств Linear. OpenChamber хранит данные входа на этом компьютере, чтобы ими пользовались Web, Desktop и подключённый телефон.',
    ...
    'settings.integrations.linear.actions.connect': 'Подключить',
    'settings.integrations.linear.actions.disconnect': 'Отключить',
    'settings.integrations.linear.actions.addWorkspace': 'Добавить рабочее пространство',
    ...
    'settings.integrations.linear.flow.description': 'Завершите вход во вкладке браузера, которая только что открылась.',
    ...
    'settings.integrations.linear.toast.workspaceSwitched': 'Рабочее пространство Linear изменено',
    'settings.integrations.linear.toast.workspaceSwitchFailed': 'Не удалось сменить рабочее пространство Linear',
    ...
    'settings.integrations.linear.toast.authorizationFailed': 'Время ожидания авторизации Linear истекло. Нажмите «Подключить», чтобы повторить.',
    'settings.integrations.linear.avatarAlt.withName': 'Аватар Linear: {name}',
    ...
    'settings.integrations.linear.mapping.defaultProject.info': 'Новые сессии из задач Linear используют этот проект, если для команды задачи не настроено собственное соответствие.',
    'settings.integrations.linear.mapping.defaultProject.placeholder': 'Нет',
    'settings.integrations.linear.mapping.defaultProject.aria': 'Проект по умолчанию для задач Linear',
    'settings.integrations.linear.mapping.teams': 'Проекты команд',
    'settings.integrations.linear.mapping.teams.info': 'Необязательно. Задача из сопоставленной команды откроется в этом проекте вместо проекта по умолчанию.',
    'settings.integrations.linear.mapping.teams.useDefault': 'Использовать по умолчанию',
    'settings.integrations.linear.mapping.teams.aria': 'Проект команды Linear {team}',
    'settings.integrations.linear.mapping.emptyProjects': 'Сначала добавьте проект, затем сопоставьте с ним команды Linear.',
    'settings.integrations.linear.mapping.emptyTeams': 'В этом рабочем пространстве Linear нет команд.',
    'settings.integrations.linear.mapping.loadFailed': 'Не удалось загрузить сопоставление проектов Linear.',
    'settings.integrations.linear.sessionComments.label': 'Комментарии сессии',
    'settings.integrations.linear.sessionComments.info': 'Добавляет комментарий к задаче при запуске, завершении или ошибке сессии. Комментарии публикуются только если у сервера есть публичный адрес, чтобы ссылка открывала сессию для всех участников задачи.',
    'settings.integrations.linear.sessionComments.aria': 'Публиковать статусы сессии в Linear',
