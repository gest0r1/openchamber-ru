...
export const linearPanelI18n = {
  ...
  ru: {
    ...
    'contextPanel.linear.actions.startSession': 'Запустить сессию',
    'contextPanel.linear.actions.closeIssue': 'Закрыть задачу',
    ...
    'contextPanel.linear.label.unassigned': 'Не назначено',
    'contextPanel.linear.label.priority': 'Приоритет',
    'contextPanel.linear.label.labels': 'Метки',
    'contextPanel.linear.priority.none': 'Без приоритета',
    'contextPanel.linear.priority.urgent': 'Срочный',
    ...
    'contextPanel.linear.label.statusAria': 'Статус задачи Linear',
    'contextPanel.linear.label.workspace': 'Рабочее пространство',
    'contextPanel.linear.label.workspaceAria': 'Рабочее пространство Linear',
    'contextPanel.linear.filter.statusAria': 'Фильтровать задачи по статусу',
    'contextPanel.linear.filter.assigneeAria': 'Фильтровать задачи по исполнителю',
    'contextPanel.linear.filter.teamAria': 'Фильтровать задачи по команде',
    'contextPanel.linear.filter.priorityAria': 'Фильтровать задачи по приоритету',
    'contextPanel.linear.filter.searchAria': 'Поиск задач',
    ...
    'contextPanel.linear.filter.status.todo': 'К выполнению',
    'contextPanel.linear.filter.status.started': 'В работе',
    'contextPanel.linear.filter.status.inReview': 'На проверке',
    ...
    'contextPanel.linear.filter.assignee.me': 'Назначенные мне',
    ...
    'contextPanel.linear.empty.noMatchingIssues': 'Нет задач, соответствующих фильтрам',
    'contextPanel.linear.loading.issue': 'Загрузка задачи…',
    'contextPanel.linear.toast.statusUpdated': 'Статус задачи обновлён',
    'contextPanel.linear.toast.statusUpdateFailed': 'Не удалось обновить статус задачи',
