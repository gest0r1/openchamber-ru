...
export const linearIssuePickerI18n = {
  ...
  ru: {
    ...
    'session.linearIssuePicker.title': 'Связать с задачей Linear',
    'session.linearIssuePicker.description': 'Выберите задачу в подключённом рабочем пространстве Linear.',
    ...
    'session.linearIssuePicker.empty.noIssuesFound': 'Задачи не найдены',
    'session.linearIssuePicker.empty.noOpenIssuesFound': 'Открытые задачи не найдены',
    'session.linearIssuePicker.loading.issues': 'Загрузка задач…',
    ...
    'session.linearIssuePicker.actions.loadMore': 'Загрузить ещё',
    'session.linearIssuePicker.actions.openInLinearAria': 'Открыть в Linear',
    'session.linearIssuePicker.toast.loadMoreFailed': 'Не удалось загрузить дополнительные задачи',
    'session.linearIssuePicker.toast.loadIssueDetailsFailed': 'Не удалось загрузить сведения о задаче',
    ...
    'session.linearIssuePicker.error.issueNotFound': 'Задача не найдена',
    'chat.chatInput.actions.newSessionFromLinearIssue': 'Новая сессия из задачи Linear',
    'session.linearIssuePicker.title.createSession': 'Новая сессия из задачи Linear',
    'session.linearIssuePicker.description.createSession': 'Создаёт сессию в проекте, сопоставленном с этой командой Linear, используя задачу как первый промпт.',
    ...
    'session.linearIssuePicker.toast.sendContextFailed': 'Не удалось отправить контекст задачи',
    'session.linearIssuePicker.toast.sessionCreated': 'Сессия создана из задачи',
    'session.linearIssuePicker.toast.startSessionFailed': 'Не удалось запустить сессию',
